    ...
    <header class="bg-white dark:bg-slate-800 shadow transition-colors duration-300 fixed top-0 left-0 right-0 z-50">
                ...
                <div class="flex gap-1">
                    <?php $__currentLoopData = $langs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(app()->getLocale() != $code): ?>
                            <a href="/lang/<?php echo e($code); ?>" class="px-3 max-sm:px-2 py-1.5 max-sm:py-1 rounded-lg text-xs font-semibold
                                <?php echo e($code == 'ar' ? 'bg-red-600 dark:bg-slate-700 text-white' : 'bg-rose-500 text-white'); ?>

                                hover:opacity-80 transition"><?php echo e($label); ?></a>
                        <?php endif; ?>
        ...
        <div class="lg:hidden" x-data="{ mobileOpen: false }">
            ...
            <div :class="{ 'block': mobileOpen, 'hidden': !mobileOpen }" class="border-t border-gray-200 dark:border-slate-700 px-6 py-4 space-y-3 bg-rose-50 dark:bg-slate-900">
                <a href="/" class="block text-gray-700 dark:text-slate-300 hover:text-rose-500 transition-colors"><?php echo e(__('app.home')); ?></a>
                <a href="/about" class="block text-gray-700 dark:text-slate-300 hover:text-rose-500 transition-colors"><?php echo e(__('app.about')); ?></a>
                <a href="/services" class="block text-gray-700 dark:text-slate-300 hover:text-rose-500 transition-colors"><?php echo e(__('app.services')); ?></a>
                <a href="/certificates" class="block text-gray-700 dark:text-slate-300 hover:text-rose-500 transition-colors"><?php echo e(__('app.certificates')); ?></a>
                <a href="/contact" class="block text-gray-700 dark:text-slate-300 hover:text-rose-500 transition-colors"><?php echo e(__('app.contact')); ?></a>
            </div>
        </div>
    </header>
